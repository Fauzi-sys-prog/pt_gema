...
export default function DataCollection() {
  ...
  const [formData, setFormData] = useState({
    ...
    workSections: [{ id: "work-section-1", title: "Pekerjaan Utama", items: [] }],
  ...
  const handleEditData = (item: DataCollectionType) => {
    setFormData({
      ...
      workSections: item.workSections?.length ? item.workSections : [{ id: "work-section-1", title: "Pekerjaan Utama", items: [] }],
  ...
  const resetForm = () => {
    setFormData({
      ...
      consumables: [],
      equipment: [],
      workSections: [{ id: `work-section-${Date.now()}`, title: "Pekerjaan Utama", items: [] }],
      status: "Draft",
      notes: "",
      priority: "Medium",
      tags: [],
