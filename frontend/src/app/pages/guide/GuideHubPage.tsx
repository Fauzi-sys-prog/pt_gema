          ...
          <div className="space-y-4">
             ...
             <div className="flex flex-col gap-4">
                {[
                  ...
                  '2. Project Quotation: Sales membuat penawaran berbasis RAB/SOW.',
          ...
          <div className="space-y-6 text-slate-600">
            <section className="space-y-3 p-6 bg-slate-50 rounded-3xl border border-slate-100">
              <h3 className="text-lg font-black text-slate-900 uppercase italic flex items-center gap-2">
                ...
                Project Quotation Hub
              </h3>
              <p className="text-sm font-medium italic">Pusat pembuatan penawaran. Pastikan Bapak memilih mode <span className="font-bold">RAB</span> untuk rincian biaya atau <span className="font-bold">SOW</span> untuk rincian lingkup kerja teknis.</p>
            ...
            <section className="space-y-3 p-6 bg-slate-50 rounded-3xl border border-slate-100">
              ...
              <p className="text-sm font-medium italic">Sistem akan menyarankan penerbitan invoice setiap kali ada Berita Acara (BA) yang disetujui atau milestone proyek tercapai.</p>
            </section>
            <section className="space-y-3 p-6 bg-slate-50 rounded-3xl border border-slate-100">
              <h3 className="text-lg font-black text-slate-900 uppercase italic flex items-center gap-2">
          ...
          <div className="space-y-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1 p-6 bg-slate-50 rounded-3xl border border-slate-100">
                <h3 className="text-sm font-black text-slate-900 uppercase italic mb-3">Work Order (WO)</h3>
                <p className="text-xs text-slate-500 font-medium italic mb-4">Instruksi resmi bagi tim workshop. WO memuat target kuantitas, deadline, dan daftar teknisi penanggung jawab.</p>
                <div className="flex items-center gap-2 text-[10px] font-black text-blue-600 uppercase bg-blue-50 p-2 rounded-lg">
                  <Zap size={12} /> Otomatis dibuat dari SPK
                </div>
              </div>
              <div className="flex-1 p-6 bg-slate-50 rounded-3xl border border-slate-100">
                <h3 className="text-sm font-black text-slate-900 uppercase italic mb-3">Laporan Harian (LHP)</h3>
                <p className="text-xs text-slate-500 font-medium italic mb-4">Setiap output produksi hari ini wajib diinput ke LHP agar stok barang jadi (FG) bertambah secara otomatis.</p>
                <div className="flex items-center gap-2 text-[10px] font-black text-emerald-600 uppercase bg-emerald-50 p-2 rounded-lg">
                  <ShieldCheck size={12} /> Sinkron ke Payroll Insentif
                </div>
              </div>
            </div>
            <div className="p-6 bg-slate-900 text-white rounded-3xl shadow-lg">
              <h3 className="text-lg font-black uppercase italic tracking-tight text-amber-400 mb-2">Quality Control (QC)</h3>
              <p className="text-xs text-slate-400 font-medium leading-relaxed italic">
                Barang yang sudah selesai diproduksi harus melalui verifikasi QC. Barang yang "Rejected" tidak dapat diterbitkan Surat Jalan-nya hingga diperbaiki.
              </p>
            </div>
          </div>
        </div>
