...
export function QuotationToProjectStats() {
  ...
  const draftQuotations = quotationList.filter(q => q.status === 'Draft').length;
  const sentQuotations = quotationList.filter(q => q.status === 'Sent').length;
  const approvedQuotations = quotationList.filter(q => q.status === 'Approved').length;
  const rejectedQuotations = quotationList.filter(q => q.status === 'Rejected').length;
