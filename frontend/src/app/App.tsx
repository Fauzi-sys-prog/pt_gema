    ...
    if (this.state.error) {
      return (
        ...
        >
          ...
          <pre
            style={{ whiteSpace: "pre-wrap", color: "#1e293b", fontSize: 13 }}
          >
...
const QuotationApprovalPage = lazy(
...
const ProductionTimelinePage = lazy(
  () => import("./pages/production/ProductionTimelinePage"),
);
const ProductionTrackerPage = lazy(() =>
  import("./pages/production/Tracker").then((m) => ({
    default: m.ProductionTrackerPage,
  })),
);
const ProductionGuidePage = lazy(
  () => import("./pages/production/ProductionGuidePage"),
);
const QCInspectionPage = lazy(
  () => import("./pages/production/QCInspectionPage"),
);

// Inventory
const WarehouseLedgerPage = lazy(
...
const StockJournalPage = lazy(
  () => import("./pages/inventory/StockJournalPage"),
);
const StockCardDetailPage = lazy(
...
const PenilaianKinerjaPage = lazy(
...
const EmployeeAdvancePage = lazy(
...
const ProjectProfitLossPage = lazy(
...
const PettyCashGudangPage = lazy(
  () => import("./pages/finance/PettyCashGudangPage"),
);
...
const TambahanBiayaProyekPage = lazy(
  () => import("./pages/finance/TambahanBiayaProyekPage"),
);
const AccountsReceivablePage = lazy(
  () => import("./pages/finance/AccountsReceivablePage"),
);
const CashFlowCommandCenter = lazy(
...
const PayrollReportPage = lazy(
  () => import("./pages/finance/PayrollReportPage"),
);
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route
                  ...
                  element={<Navigate to="/finance/cashflow-command" replace />}
                />
                <Route
                  path="/finance/piutang"
                  element={
                    <Navigate to="/finance/accounts-receivable" replace />
                  }
                />
                <Route
              ...
              */}
                ...
                <Route
                  ...
                  element={
                    <Navigate to="/hr/employee-advance?type=employee" replace />
                  }
                />
                <Route
                  path="/hr/kasbon-thl"
