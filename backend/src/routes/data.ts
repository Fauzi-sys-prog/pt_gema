    ...
    case "production-reports": {
      await prisma.productionExecutionReport.create({
        data: {
          ...
          manualMode: Boolean(record.manualMode),
          manualModeType: asTrimmedString(record.manualModeType) || undefined,
          selectedItem: asTrimmedString(record.selectedItem) || undefined,
          selectedItemCode: asTrimmedString(record.selectedItemCode) || undefined,
          selectedItemName: asTrimmedString(record.selectedItemName) || undefined,
          stockPostingStatus: asTrimmedString(record.stockPostingStatus) || undefined,
          releasedStockInId: asTrimmedString(record.releasedStockInId) || undefined,
          releasedToStockAt: asTrimmedString(record.releasedToStockAt) ? new Date(String(record.releasedToStockAt)) : undefined,
          workflowStatus: asTrimmedString(record.workflowStatus) || undefined,
        },
      });
      return relationalProductionFindUnique(resource, entityId);
    ...
    case "qc-inspections": {
      ...
      await (prisma as any).productionQcInspection.create({
        data: {
          ...
          warehouseReceiptStatus: asTrimmedString(record.warehouseReceiptStatus) || undefined,
          releasedStockInId: asTrimmedString(record.releasedStockInId) || undefined,
          releasedToWarehouseAt: asTrimmedString(record.releasedToWarehouseAt) ? new Date(String(record.releasedToWarehouseAt)) : undefined,
          workflowStatus: asTrimmedString(record.workflowStatus) || undefined,
          dimensions: {
            create: dimensions,
          },
    ...
    case "production-reports": {
      await prisma.productionExecutionReport.update({
        ...
        data: {
          ...
          manualMode: Boolean(record.manualMode),
          manualModeType: asTrimmedString(record.manualModeType) || null,
          selectedItem: asTrimmedString(record.selectedItem) || null,
          selectedItemCode: asTrimmedString(record.selectedItemCode) || null,
          selectedItemName: asTrimmedString(record.selectedItemName) || null,
          stockPostingStatus: asTrimmedString(record.stockPostingStatus) || null,
          releasedStockInId: asTrimmedString(record.releasedStockInId) || null,
          releasedToStockAt: asTrimmedString(record.releasedToStockAt) ? new Date(String(record.releasedToStockAt)) : null,
          workflowStatus: asTrimmedString(record.workflowStatus) || null,
        },
      });
      return relationalProductionFindUnique(resource, entityId);
    ...
    case "qc-inspections": {
      ...
      await (prisma as any).productionQcInspection.update({
        ...
        data: {
          ...
          warehouseReceiptStatus: asTrimmedString(record.warehouseReceiptStatus) || null,
          releasedStockInId: asTrimmedString(record.releasedStockInId) || null,
          releasedToWarehouseAt: asTrimmedString(record.releasedToWarehouseAt) ? new Date(String(record.releasedToWarehouseAt)) : null,
          workflowStatus: asTrimmedString(record.workflowStatus) || null,
          dimensions: {
            deleteMany: {},
            create: dimensions,
