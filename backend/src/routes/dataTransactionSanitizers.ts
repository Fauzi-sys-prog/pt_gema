...
export function sanitizeVendorExpensePayload(
  ...
  const costRecognition = assertStatusInList(asTrimmedString(merged.costRecognition), ["DIRECT_PROJECT", "STOCK_ISSUE"], "vendor-expenses cost recognition");
  ...
  return {
    ...
    costRecognition: costRecognition || "DIRECT_PROJECT",
  };
}
